  ...
  <section class="cs_page_heading cs_center cs_bg_filed" data-src="assets/img/page_heading_bg.jpg">
    <div class="container">
      <div class="cs_page_heading_in">
        <h1 class="cs_page_heading_title cs_fs_48 cs_white_color">Doctors</h1>
  ...
  <section>
    ...
    <div class="container">
      <div class="cs_section_heading cs_style_1 cs_text_center">
        <p class="cs_section_subtitle cs_fs_18 cs_semibold cs_accent_color cs_heading_font">Doctor’s Team</p>
        <h2 class="cs_section_title cs_fs_48 mb-0">Meet our Expert Counselling <br>Doctors</h2>
      </div>
      ...
      <div class="row cs_row_gap_30 cs_gap_y_30">
        <div class="col-xl-3 col-lg-4 col-sm-6">
          <div class="cs_team cs_style_1 cs_type_2">
            ...
            <div class="cs_team_bio">
              ...
              <p class="cs_team_subtitle cs_heading_color mb-0">Therapist Expert</p>
            </div>
          </div>
        </div>
        <div class="col-xl-3 col-lg-4 col-sm-6">
          <div class="cs_team cs_style_1 cs_type_2">
            <div class="cs_team_thumbnail cs_center">
              <img src="assets/img/team_7.jpeg" alt="Team Thumbnail">
              <div class="cs_social_btns cs_style_2 position-absolute">
                <a href="#" class="cs_center cs_share"><i class="fa-brands fa-facebook-f"></i></a>
                <a href="#" class="cs_center"><i class="fa-brands fa-x-twitter"></i></a>
                <a href="#" class="cs_center"><i class="fa-brands fa-instagram"></i></a>
            ...
            <div class="cs_team_bio">
              <h3 class="cs_team_title cs_fs_20 cs_medium cs_heading_color"><a href="doctor-details.html">Dianne
                  Russell</a></h3>
              <p class="cs_team_subtitle cs_heading_color mb-0">Associate Eye Specialist</p>
            </div>
          </div>
        </div>
        <div class="col-xl-3 col-lg-4 col-sm-6">
          <div class="cs_team cs_style_1 cs_type_2">
            <div class="cs_team_thumbnail cs_center">
              <img src="assets/img/team_20.jpeg" alt="Team Thumbnail">
              <div class="cs_social_btns cs_style_2 position-absolute">
                <a href="#" class="cs_center cs_share"><i class="fa-brands fa-facebook-f"></i></a>
                <a href="#" class="cs_center"><i class="fa-brands fa-x-twitter"></i></a>
                <a href="#" class="cs_center"><i class="fa-brands fa-instagram"></i></a>
            ...
            <div class="cs_team_bio">
              <h3 class="cs_team_title cs_fs_20 cs_medium cs_heading_color"><a href="doctor-details.html">Marvin
                  McKin</a></h3>
              <p class="cs_team_subtitle cs_heading_color mb-0">Therapist Expert</p>
            </div>
          </div>
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6">
          <div class="cs_team cs_style_1 cs_type_2">
            <div class="cs_team_thumbnail cs_center">
              <img src="assets/img/team_21.jpeg" alt="Team Thumbnail">
              <div class="cs_social_btns cs_style_2 position-absolute">
                <a href="#" class="cs_center cs_share"><i class="fa-brands fa-facebook-f"></i></a>
                <a href="#" class="cs_center"><i class="fa-brands fa-x-twitter"></i></a>
                <a href="#" class="cs_center"><i class="fa-brands fa-instagram"></i></a>
            ...
            <div class="cs_team_bio">
              <h3 class="cs_team_title cs_fs_20 cs_medium cs_heading_color"><a href="doctor-details.html">Arlene
                  McCoy</a></h3>
              <p class="cs_team_subtitle cs_heading_color mb-0">Psychologist</p>
            </div>
          </div>
        </div>
        <div class="col-xl-3 col-lg-4 col-sm-6">
          <div class="cs_team cs_style_1 cs_type_2">
            ...
            <div class="cs_team_bio">
              <h3 class="cs_team_title cs_fs_20 cs_medium cs_heading_color"><a href="doctor-details.html">Dr. Dimane
                  Russell</a></h3>
              <p class="cs_team_subtitle cs_heading_color mb-0">Associate Eye Specialist</p>
            </div>
          </div>
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6">
          <div class="cs_team cs_style_1 cs_type_2">
            <div class="cs_team_thumbnail cs_center">
              <img src="assets/img/team_22.jpeg" alt="Team Thumbnail">
              <div class="cs_social_btns cs_style_2 position-absolute">
                <a href="#" class="cs_center cs_share"><i class="fa-brands fa-facebook-f"></i></a>
                <a href="#" class="cs_center"><i class="fa-brands fa-x-twitter"></i></a>
                <a href="#" class="cs_center"><i class="fa-brands fa-instagram"></i></a>
            ...
            <div class="cs_team_bio">
              <h3 class="cs_team_title cs_fs_20 cs_medium cs_heading_color"><a href="doctor-details.html">Dr.Dianne
                  Brook</a></h3>
              <p class="cs_team_subtitle cs_heading_color mb-0">Associate Eye Specialist</p>
            </div>
          </div>
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6">
          <div class="cs_team cs_style_1 cs_type_2">
            ...
            <div class="cs_team_bio">
              <h3 class="cs_team_title cs_fs_20 cs_medium cs_heading_color"><a href="doctor-details.html">Dr. Marvin
                  Mollice</a></h3>
              <p class="cs_team_subtitle cs_heading_color mb-0">Therapist Expert</p>
            </div>
          </div>
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6">
          <div class="cs_team cs_style_1 cs_type_2">
            <div class="cs_team_thumbnail cs_center">
              <img src="assets/img/team_23.jpeg" alt="Team Thumbnail">
              <div class="cs_social_btns cs_style_2 position-absolute">
                <a href="#" class="cs_center cs_share"><i class="fa-brands fa-facebook-f"></i></a>
                <a href="#" class="cs_center"><i class="fa-brands fa-x-twitter"></i></a>
                <a href="#" class="cs_center"><i class="fa-brands fa-instagram"></i></a>
            ...
            <div class="cs_team_bio">
              <h3 class="cs_team_title cs_fs_20 cs_medium cs_heading_color"><a href="doctor-details.html">Dr. Rosie
                  Forced Bin</a></h3>
              <p class="cs_team_subtitle cs_heading_color mb-0">Associate Eye Specialist</p>
            </div>
          </div>
      ...
      <div class="cs_center">
        <a href="#" class="cs_btn cs_style_1 cs_fs_18 cs_semibold cs_accent_bg cs_radius_100">
          <span class="cs_btn_text">View Details</span>
        </a>
      </div>
    </div>
  </section>
        ...
        <div class="col-lg-4">
          <article class="cs_post cs_style_1">
            ...
            <div class="cs_post_info">
              ...
              <h3 class="cs_post_title cs_fs_32"><a href="blog-details.html">
                Medi Tips How to Physical Fitness your Health</a>
              </h3>
        ...
        <div class="col-lg-4">
          <article class="cs_post cs_style_1">
            ...
            <div class="cs_post_info">
              ...
              <h3 class="cs_post_title cs_fs_32"><a href="blog-details.html">
                How to Get Best Care 7 Step for your Eyes</a>
                </h3>
              <a href="blog-details.html" class="cs_text_btn cs_fs_18 cs_heading_color">
                <span>Learn More</span>
                <div class="cs_text_btn_icon cs_center">
