<div class="header">
    ...
    <div class="pull-right p-r-15">
        <ul>
            ...
            <li class="header-icon dib">
                ...
                <div class="drop-down">
                    <div class="dropdown-content-heading">
                        ...
                        <a href="{{ route('admin.email') }}"><i class="ti-pencil-alt pull-right"></i></a>
                    </div>
                    <div class="dropdown-content-body">
                        <ul>
            ...
            <!-- User Profile -->
            <li class="header-icon dib">
                <img class="avatar-img" src="{{ asset('assets/images/avatar/1.jpg') }}" alt="" />
                <span class="user-avatar"> {{ Auth::user()->name ?? 'Ajay' }} <i class="ti-angle-down f-s-10"></i></span>
                <div class="drop-down dropdown-profile">
                    ...
                    <div class="dropdown-content-body">
                        <ul>
                            ...
                            <li><a href="{{ route('admin.calender') }}"><i class="ti-calendar"></i> <span>My Calender</span></a></li>
                            <li><a href="{{ route('admin.email') }}"><i class="ti-email"></i> <span>Inbox</span></a></li>
                            <li><a href="#"><i class="ti-settings"></i> <span>Setting</span></a></li>
                            <li><a href="#"><i class="ti-help-alt"></i> <span>Help</span></a></li>
                            <li><a href="#"><i class="ti-lock"></i> <span>Lock Screen</span></a></li>
                            <li>
                                <a href="{{ route('admin.logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form-header').submit();">
