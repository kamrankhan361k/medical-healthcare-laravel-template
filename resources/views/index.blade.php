      ...
      <div class="container-fluid">
        <div class="cs_main_header_in">
                    ...
                    <ul class="cs_mega_wrapper cs_with_thumb">
                      ...
                      <li>
                        <a href="rehabilitations.html">
                          <img src="assets/img/demo/4_rehabilatations-center.jpg" alt="">Rehabilatations Center
                        </a>
                      </li>
                      <li>
                        <a href="physiotherapy.html">
                          <img src="assets/img/demo/5_physiotherepy_center.jpg" alt="">Physiotherepy Center
                        </a>
                      </li>
                      <li>
                        <a href="psychology.html">
                          <img src="assets/img/demo/6_psychology.jpg" alt="">Psychology
                        </a>
                      </li>
                    </ul>
                  </li>
          ...
          <div class="cs_main_header_right">
            ...
            <a href="appointment.html" class="cs_btn cs_style_1 cs_fs_18 cs_semibold cs_accent_bg  cs_radius_100"><span class="cs_btn_text">Make An Appointment</span></a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="cs_hero_content_wrapper">
        <div class="cs_hero_content wow fadeInRight" data-wow-duration="0.9s" data-wow-delay="0.25s">
          ...
          <p class="cs_hero_subtitle cs_fs_20 cs_medium cs_white_color cs_heading_font">Protect your smile and keep it
  ...
  <section class="cs_department cs_style_1">
    ...
    <div class="container">
      <div class="cs_section_heading cs_style_1 cs_text_center wow fadeInUp" data-wow-duration="0.9s" data-wow-delay="0.25s">
        ...
        <h2 class="cs_section_title cs_fs_48 mb-0">experienced in Multiple medical <br> practices for <span class="cs_accent_color">your Health</span></h2>
      </div>
    ...
    <div class="container">
      <div class="cs_section_heading cs_style_1 cs_type_1 wow fadeInUp" data-wow-duration="0.9s" data-wow-delay="0.25s">
        <div class="cs_section_heading_left">
          ...
          <h2 class="cs_section_title cs_fs_48 mb-0">Transform Our Latest Success <span class="cs_accent_color">Case studies</span></h2>
        </div>
          ...
          <div class="cs_slide">
            <div class="cs_card cs_style_1 cs_radius_10">
              ...
              <div class="cs_card_bio">
                ...
                <h3 class="cs_card_title cs_fs_24 cs_bold"><a href="case-studies-details.html">Supports Patients</a>
                </h3>
          ...
          <div class="cs_slide">
            <div class="cs_card cs_style_1 cs_radius_10">
              ...
              <div class="cs_card_bio">
                ...
                <h3 class="cs_card_title cs_fs_24 cs_bold"><a href="case-studies-details.html">Two Baby cesar opr.</a>
                </h3>
                <a href="case-studies-details.html" class="cs_card_btn">
                  <span>Learn More</span>
                  <div class="cs_card_btn_icon cs_center">
          ...
          <div class="cs_slide">
            <div class="cs_card cs_style_1 cs_radius_10">
              ...
              <div class="cs_card_bio">
                ...
                <h3 class="cs_card_title cs_fs_24 cs_bold"><a href="case-studies-details.html">Heart Surgery</a></h3>
                <a href="case-studies-details.html" class="cs_card_btn">
                  <span>Learn More</span>
                  <div class="cs_card_btn_icon cs_center">
                    <span><i class="fa-solid fa-arrow-right-long"></i></span>
          ...
          <div class="cs_slide">
            <div class="cs_card cs_style_1 cs_radius_10">
              ...
              <div class="cs_card_bio">
                ...
                <h3 class="cs_card_title cs_fs_24 cs_bold"><a href="case-studies-details.html">Eye Care Services</a>
                </h3>
                <a href="case-studies-details.html" class="cs_card_btn">
                  <span>Learn More</span>
                  <div class="cs_card_btn_icon cs_center">
  ...
  <section class="cs_video_section cs_style_1 cs_accent_bg position-relative">
    <div class="container">
      <div class="cs_vider_wrapper cs_style_1">
        <a href="https://www.youtube.com/embed/rRid6GCJtgc" class="cs_player_btn cs_style_2 cs_center cs_video_open wow zoomIn" data-wow-duration="0.9s" data-wow-delay="0.25s">
          <span></span>
        </a>
        <h2 class="cs_video_title">We are Provide All Medical Service <br>For Your <span class="cs_accent_color">Health</span> Needs.</h2>
        <p class="cs_video_subtitle">Adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad <br> minim veniam, quis nostrud.</p>
  ...
  <section class="cs_service_area cs_accent_bg position-relative">
    ...
    <div class="container">
      <div class="cs_section_heading cs_style_1 cs_type_1">
        <div class="cs_section_heading_right cs_white_color_8">Far far away, behind the word bore et dolore magna
          aliqua. Ut enim ad minim veniam, quis nostrud countries and Consonantia, there live the blind texts Vokalia
          and nostrud.</div>
        <div class="cs_section_heading_left">
          <p class="cs_section_subtitle cs_white_color">Expertise</p>
          <h2 class="cs_section_title cs_white_color">We offer more than Services & all Solutions Medical.</h2>
        </div>
      </div>
      <div class="cs_height_50 cs_height_lg_40"></div>
          ...
          <div class="cs_iconbox_wrapper cs_style_2">
            <div class="cs_iconbox cs_style_2 wow fadeInUp" data-wow-duration="0.9s" data-wow-delay="0.25s">
              ...
              <div class="cs_iconbox_text">
                <h3 class="cs_iconbox_title cs_fs_24 cs_white_color"><a href="service-details.html">Medical Service</a>
                </h3>
                <p class="cs_iconbox_subtitle cs_white_color">Adipiscing elit, sed do eiusmod tempor incididunt ut
                ...
                <div class="cs_slider_wrapper">
                  <div class="cs_slide">
                    <div class="cs_testimonial cs_style_1">
                      ...
                      <p class="cs_testimonial_subtitle cs_fs_32">Pain management was effective, and I was comfortable
                        during and after the treatment. The staff provided emotional support and made sure I understood
            ...
            <div class="col-12">
              <div class="cs_iconbox cs_style_3">
                ...
                <div class="cs_iconbox_text">
                  ...
                  <p class="cs_iconbox_subtitle cs_white_color mb-0">Far far away, behind the word bore et dolore magna
